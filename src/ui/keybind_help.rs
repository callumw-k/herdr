...
pub(super) fn keybind_help_groups(app: &AppState) -> Vec<HelpGroup> {
    ...
    let workspace_tab = vec![
        ...
        help_entry(keybind_label(&kb.pin_workspace_path), "pin workspace path"),
        help_entry(
            keybind_label(&kb.toggle_declared_repo),
    ...
    let panes = vec![
        ...
        help_entry(keybind_label(&kb.arrangement_next), "next arrangement"),
        help_entry(
            keybind_label(&kb.arrangement_previous),
            "previous arrangement",
        ),
        help_entry(keybind_label(&kb.new_pane), "new pane"),
