...
pub(crate) fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::WorkspaceSetPath(_) => "workspace.set_path",
        ...
        Method::TabFloatActivate(_) => "tab.float_activate",
        Method::TabArrangement(_) => "tab.arrangement",
        Method::TabPaneAdd(_) => "tab.pane_add",
        Method::WorkspacePathPinToggle(_) => "workspace.path_pin_toggle",
        Method::WorkspaceDeclaredRepoToggle(_) => "workspace.declared_repo_toggle",
